# Run this in an administrative PowerShell prompt to install the PowerFIGlet PowerShell module:
#
# 	iex (New-Object Net.WebClient).DownloadString("https://github.com/MischaBoender/PowerFIGlet/raw/master/Install.ps1")

# Some general variables
$ModuleName = 'PowerFIGlet'
$DownloadURL = 'https://github.com/MischaBoender/PowerFIGlet/raw/master/release/PowerFIGlet-current.zip'
